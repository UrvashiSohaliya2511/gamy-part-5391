...
const WomenList = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://nordstrom-2o0p.onrender.com/women?type=clothes")
      .then((res) => {
        setdata(res.data);
  ...
  const handleTabs = (e) => {
    ...
    axios
      .get(
        `https://nordstrom-2o0p.onrender.com/women?type=clothes&category=${type}`
      )
      .then((res) => {
        setdata(res.data);
      })
        ...
        <Stack>
          <Tabs colorScheme="global.blue">
            <TabList>
              ...
              <Tab onClick={handleTabs} value="top">
                {" "}
                Tops
              </Tab>
              <Tab onClick={handleTabs} value="saree">
                {" "}
                Sarees
              </Tab>
              <Tab onClick={handleTabs} value="suit">
                Jumpsuit
              </Tab>
              <Hide below="md">
